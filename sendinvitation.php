      ...
      <!-- //////start row -->
          <div class="row">
            <div class="col-lg-12">
             ...
             <h4 class="text-black-50 fw-bold"><u>Acedemic Officers</u></h4>
             <!-- .................../////////table........... -->
...
$usersrs = Database::search("SELECT * FROM `academic_officer` WHERE `invitationSend`='1'");
$d = $usersrs->num_rows;
$row = $usersrs->fetch_assoc();
$result_per_page = 10;
$number_of_pages = ceil($d / $result_per_page);
$page_first_result = ((int)$pageno - 1) * $result_per_page;
$selectedrs = Database::search("SELECT * FROM `academic_officer` WHERE `invitationSend`='1' LIMIT " . $result_per_page . " OFFSET " . $page_first_result . "");
...
?>
  <tbody>
              ...
              <td>
<button class="btn btn-success ms-1 ms-lg-5 mb-1" onclick="sendinvitation(<?php echo $srow['id']; ?>);">Send</button>
              </td>
          </tr>
          </tbody>
      <?php
...
$usersrs = Database::search("SELECT * FROM `teacher` WHERE `invitationSend`='1'");
$d = $usersrs->num_rows;
$row = $usersrs->fetch_assoc();
$result_per_page = 10;
$number_of_pages = ceil($d / $result_per_page);
$page_first_result = ((int)$pageno - 1) * $result_per_page;
$selectedrs = Database::search("SELECT * FROM `teacher` WHERE `invitationSend`='1' LIMIT " . $result_per_page . " OFFSET " . $page_first_result . "");
$srn = $selectedrs->num_rows;
while ($srow = $selectedrs->fetch_assoc()) {
?>
  <tbody>
              ...
              <td>
<button class="btn btn-success ms-1 ms-lg-5 mb-1" onclick="sendinvitationteacher(<?php echo $srow['id']; ?>);">Send</button>
              </td>
          </tr>
          </tbody>
      <?php
  ...
  <div class="col-12 justify-content-center fs-5 fw-bold mt-2 text-center">
             ...
             <!-- ................///////////table end............... -->
              ...
              <div class="col-lg-12 mt-3">
              <div class="card-style">
              <h4 class="text-black-50 fw-bold"><u>Students</u></h4>
                                   <!-- .................../////////table........... -->
             <div class="container wrapper">
  <table class="table table-bordered table-hover" cellspacing="0" width="100%">
      <thead>
...
?>
  <tbody>
              ...
              <td>
<button class="btn btn-success ms-1 ms-lg-5 mb-1" onclick="sendinvitationstudent(<?php echo $srow['student_id']; ?>);">Send</button>
              </td>
          </tr>
          </tbody>
      <?php
