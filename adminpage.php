   ...
   <aside class="sidebar-nav-wrapper">
    ...
    <main class="main-wrapper">
      ...
      <section class="section">
          ...
          <div class="row">
            <div class="col-xl-3 col-lg-4 col-sm-6">
              <div class="icon-card mb-30">
                ...
                <div class="content">
                  <h6 class="mb-10">Acedemic Officers</h6>
                  <?php
                  $ac = Database::search("SELECT * FROM `academic_officer`");
                  $na = $ac->num_rows;
                  ?>
                  <h3 class="text-bold mb-10"><?php echo $na; ?></h3>
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
              <div class="icon-card mb-30">
                ...
                <div class="content">
                  ...
                  $sa = $st->num_rows;
                  ?>
                  <h3 class="text-bold mb-10"><?php echo $sa; ?></h3>
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
              <div class="icon-card mb-30">
                ...
                <div class="content">
                  ...
                  <?php
                  $te = Database::search("SELECT * FROM `teacher`");
                  $tn = $te->num_rows;
                  ?>
                  <h3 class="text-bold mb-10"><?php echo $tn; ?></h3>
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
              <div class="icon-card mb-30">
                ...
                <div class="content">
                <h6 class="mb-10">Time</h6>
                <div class="p-2 fw-bold" id="MyClockDisplay" onload="showTime()">
                </div>
              </div>
              <!-- End Icon Cart -->
            </div>
        ...
        <span class="fs-4 fw-bold">AIBS Learning Management System</span>
            </div>
            <!-- End Col -->
            <div class="col-lg-5">
