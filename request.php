...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="mycss/request.css">
        ...
        <div class="container-fluid">
          ...
          <!-- ========== title-wrapper end ========== -->
           ...
           <div class="col-lg-12 mt-3">
              ...
              <h3>Acedemic Message</h3>
         <table class="table mt-3">
         <tr>
    <th>ID</th>
    <th>Acedemic Officer</th>
    <th>Message</th>
    <th>Date</th>
    <th>Reply</th>
    <th>Send</th>
           ...
           <tbody>
             <?php
              $acedemic = Database::search("SELECT * FROM `acedemic_chat`");
              $an = $acedemic->num_rows;
              $c = 0;
              for($i=0;$i<$an;$i++){
                $c++;
                $chata = $acedemic->fetch_assoc();
                ?>
             <td><?php echo $c; ?></td>
             <td><?php echo $chata["Academic_Officer_id"]; ?></td>
             <td><?php echo $chata["date"]; ?></td>
            <td><?php echo $chata["message"]; ?></td>
            <td><input type="text"/></td>
              <td><button class="btn btn-dark">Send</button></td>
  </tr>
              <?php
              }
             ?>
...
<div class="row">
  ...
  <tbody>
             <?php
              $acedemic = Database::search("SELECT * FROM `teacher_chat`");
              $an = $acedemic->num_rows;
              $c = 0;
              for($i=0;$i<$an;$i++){
                $c++;
                ...
                ?>
             <td><?php echo $c; ?></td>
             <td><?php echo $chata["teacher_chat_id"]; ?></td>
             <td><?php echo $chata["date"]; ?></td>
            <td><?php echo $chata["message"]; ?></td>
            <td><input type="text"/></td>
              <td><button class="btn btn-dark">Send</button></td>
  ...
  <tbody>
             <?php
              $acedemic = Database::search("SELECT * FROM `student_chat`");
              $an = $acedemic->num_rows;
              $c = 0;
              for($i=0;$i<$an;$i++){
                $c++;
                ...
                ?>
             <td><?php echo $c; ?></td>
             <td><?php echo $chata["student_chat_id"]; ?></td>
             <td><?php echo $chata["date"]; ?></td>
            <td><?php echo $chata["message"]; ?></td>
            <td><input type="text"/></td>
              <td><button class="btn btn-dark">Send</button></td>
