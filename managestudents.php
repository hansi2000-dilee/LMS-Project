...
$usersrs = Database::search("SELECT * FROM `student` WHERE `invitationSend`='2' ");
$d = $usersrs->num_rows;
$row = $usersrs->fetch_assoc();
$result_per_page = 10;
$number_of_pages = ceil($d / $result_per_page);
$page_first_result = ((int)$pageno - 1) * $result_per_page;
$selectedrs = Database::search("SELECT * FROM `student` WHERE `invitationSend`='2' LIMIT " . $result_per_page . " OFFSET " . $page_first_result . "");
