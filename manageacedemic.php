            ...
            <div class="row align-items-center">
              <div class="col-md-6">
                <div class="title mb-30">
                  <h2>AIBS  Manage Academic Officers</h2>
                </div>
              </div>
              <!-- end col -->
              <div class="col-md-6">
                  ...
                  <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                      <li class="breadcrumb-item">
                        <a href="#0">Manage Acedemic Officers</a>
                      </li>
      ...
      <!-- //////start row -->
          <div class="row">
            <div class="col-lg-12">
             ...
             <h4 class="text-black-50 fw-bold"><u>Academic Officers</u></h4>
             <!-- .................../////////table........... -->
...
$usersrs = Database::search("SELECT * FROM `academic_officer` WHERE `invitationSend`='2'");
$d = $usersrs->num_rows;
$row = $usersrs->fetch_assoc();
$result_per_page = 10;
$number_of_pages = ceil($d / $result_per_page);
$page_first_result = ((int)$pageno - 1) * $result_per_page;
$selectedrs = Database::search("SELECT * FROM `academic_officer` WHERE `invitationSend`='2' LIMIT " . $result_per_page . " OFFSET " . $page_first_result . "");
...
?>
  ...
  <div class="col-12 justify-content-center fs-5 fw-bold mt-2 text-center">
            ...
            <div class="col-lg-12 mt-3">
              <div class="card-style">
              <h3>Acedemic Registration</h3>
               <div class="row mt-2">
                 <div class="col-12">
                   <div class="row">
                     <div class="col-6 mt-2">
                       <label>Acedemic Officer First Name</label>
                       <input type="text" class="form-control col-12" placeholder="First Name" id="fn"/>
                     </div>
                     <div class="col-6 mt-2">
                     <label>Acedemic Officer Last Name</label>
                     <input type="text" class="form-control col-12" placeholder="Last Name" id="ln"/>
                     </div>
                     <div class="col-12 mt-2">
                     <label>Acedemic Officer Email</label>
                     <input type="email" class="form-control col-12" placeholder="Email" id="em"/>
                     </div>
                     <div class="col-8 offset-2 mt-3 mb-4"><button class="col-12 btn btn-info" onclick="registerAcedemicOfficerAdmin();">Register</button></div>
                   </div>
                 </div>
               </div>
              </div>
