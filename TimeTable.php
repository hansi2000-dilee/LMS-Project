...
<h3>Time Table For Teachers</h3>
<div class="row">
  <div class="col-12">
    <div class="row">
      <div class="col-12 col-lg-12 mt-4">
      <select class="col-12 form-select" id="t">
...
?>
      ...
      <div class="col-12 col-lg-6 mt-4" id="ti">
        <label>Time</label>
        <input type="time" class="col-12 form-control"/>
      </div>
      <div class="col-12 col-lg-6  mt-4">
      <label>Date</label>
      ...
      <div class="mt-4 col-8 offset-2 "><button class="btn btn-warning col-12">Save</button></div>
    </div>
  </div>
</div>
              </div>
      ...
      <select class="col-12 form-select" id="t">
                 ...
                 <?php
                    ...
                    for($i=0;$i<$snn;$i++){
                      $Tf = $sT->fetch_assoc();
                      ?>
                      <option value="<?php echo $Tf["student_id"] ?>"><?php echo $Tf["fname"]." ".$Tf["lname"]; ?></option>
                     <?php
                    }
                 ?>
                  </select>
