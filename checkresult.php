...
for($i=0;$i<$gn;$i++){
  ...
  ?>
<div class="col-6 col-lg-4"><button class="btn btn-success col-12 fw-bold mt-4" onclick='gradeExamloadadmin(<?php echo $g["g_id"]; ?>);' >Grade&nbsp;<?php echo $g["g_name"]; ?></button> </div>
  <?php
}
?>
</div>
