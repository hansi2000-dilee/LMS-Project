...
for($i=0;$i<$sn;$i++){
    ...
    ?>
             ...
             <div class="col-6 col-lg-4 "><button class="btn btn-dark col-12 fw-bold mt-4 justify-content-end text-center" onclick='searchexamsadmin(<?php echo $fs["id"]; ?>);'><?php echo $fs["subject_name"]; ?> &nbsp;&nbsp;&nbsp;<span class="badge badge-success"><?php echo $ssn; ?></span></button> </div>
